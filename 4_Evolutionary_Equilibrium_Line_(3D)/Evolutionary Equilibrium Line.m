...
wn_3_set=[0.05,0.05,0.05,0.05,  0.25,0.25,0.25, 0.2, 0.2, 0.2,    0.01,0.01,0.01, 0.6,0.6,0.6]; %注意这里和下面加和不能超过1
ce_3_set=[0.16,0.19,0.22,0.25,  0.5,0.55,0.6,   0.16,0.19,0.22,   0.24,0.27,0.3,  0.15,0.2,0.25];
...
LINE = ezplot3(exp1,exp2,exp3,[-1.7 -0.2]);
legend(LINE);
title('')
xlabel('x^{(3)}_{wm}')
ylabel('x^{(3)}_{ce}')
